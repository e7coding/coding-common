...
func NewStorageRedisHashTable(redis *dredis.Redis, prefix ...string) *StorageRedisHashTable {
	if redis == nil {
...
func (s *StorageRedisHashTable) GetSession(ctx context.Context, sessionId string, ttl time.Duration) (*wmap.SafeStrAnyMap, error) {
...
func (s *StorageRedisHashTable) SetSession(ctx context.Context, sessionId string, sessionData *wmap.SafeStrAnyMap, ttl time.Duration) error {
