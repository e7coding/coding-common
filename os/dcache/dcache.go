...
func Get(ctx context.Context, key interface{}) (*dvar.Var, error) {
...
func GetOrSet(ctx context.Context, key interface{}, value interface{}, duration time.Duration) (*dvar.Var, error) {
...
// It deletes the `key` if `duration` < 0 or given `value` is nil, but it does nothing
// if `value` is a function and the function result is nil.
func GetOrSetFunc(ctx context.Context, key interface{}, f Func, duration time.Duration) (*dvar.Var, error) {
...
// writing mutex lock for concurrent safety purpose.
func GetOrSetFuncLock(ctx context.Context, key interface{}, f Func, duration time.Duration) (*dvar.Var, error) {
...
func Remove(ctx context.Context, keys ...interface{}) (value *dvar.Var, err error) {
...
func Update(ctx context.Context, key interface{}, value interface{}) (oldValue *dvar.Var, exist bool, err error) {
