...
func Mkdir(path string) (err error) {
	if err = os.MkdirAll(path, os.ModePerm); err != nil {
		err = jerr.WithMsgErrF(err, `os.MkdirAll failed for path "%s" with perm "%d"`, path, os.ModePerm)
		return err
	}
	return nil
}
...
func Create(path string) (*os.File, error) {
	...
	if err != nil {
		err = jerr.WithMsgErrF(err, `os.Create failed for name "%s"`, path)
	}
	return file, err
}
...
func Open(path string) (*os.File, error) {
	...
	if err != nil {
		err = jerr.WithMsgErrF(err, `os.Open failed for name "%s"`, path)
	}
	return file, err
}
...
func OpenFile(path string, flag int, perm os.FileMode) (*os.File, error) {
	...
	if err != nil {
		err = jerr.WithMsgErrF(err, `os.OpenFile failed with name "%s", flag "%d", perm "%d"`, path, flag, perm)
	}
	return file, err
}
...
func Join(paths ...string) string {
	...
	for _, path := range paths {
		...
		s += jstr.TrimRight(path, Separator)
	}
	return s
}
...
func Chdir(dir string) (err error) {
	err = os.Chdir(dir)
	if err != nil {
		err = jerr.WithMsgErrF(err, `os.Chdir failed with dir "%s"`, dir)
	}
	return
}
...
func Stat(path string) (os.FileInfo, error) {
	...
	if err != nil {
		err = jerr.WithMsgErrF(err, `os.Stat failed for file "%s"`, path)
	}
	return info, err
}
...
func Move(src string, dst string) (err error) {
	...
	if err != nil {
		err = jerr.WithMsgErrF(err, `os.Rename failed from "%s" to "%s"`, src, dst)
	}
	return
}
...
func DirNames(path string) ([]string, error) {
	...
	if err != nil {
		err = jerr.WithMsgErrF(err, `Read dir files failed from path "%s"`, path)
		return nil, err
	}
	return list, nil
}
...
func Glob(pattern string, onlyNames ...bool) ([]string, error) {
	...
	if err != nil {
		err = jerr.WithMsgErrF(err, `filepath.Glob failed for pattern "%s"`, pattern)
		return nil, err
	}
...
func RemoveFile(path string) (err error) {
	if err = os.Remove(path); err != nil {
		err = jerr.WithMsgErrF(err, `os.Remove failed for path "%s"`, path)
	}
	return
}
...
func RemoveAll(path string) (err error) {
	if err = os.RemoveAll(path); err != nil {
		err = jerr.WithMsgErrF(err, `os.RemoveAll failed for path "%s"`, path)
	}
	return
}
...
func IsWritable(path string) bool {
	...
	if IsDir(path) {
		...
		tmpFile := strings.TrimRight(path, Separator) + Separator + jconv.String(time.Now().UnixNano())
...
func Chmod(path string, mode os.FileMode) (err error) {
	...
	if err != nil {
		err = jerr.WithMsgErrF(err, `os.Chmod failed with path "%s" and mode "%s"`, path, mode)
	}
	return
}
