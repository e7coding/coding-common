...
type priorityQueue struct {
	...
	nextPriority *atomic.Int64      // nextPriority stores the next priority value of the heap, which is used to check if necessary to call the Pop of heap by Timer.
}
