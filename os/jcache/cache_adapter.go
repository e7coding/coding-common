...
type Adapter interface {
	...
	Get(ctx context.Context, key interface{}) (*jvar.Var, error)
	...
	GetOrSet(ctx context.Context, key interface{}, value interface{}, duration time.Duration) (result *jvar.Var, err error)
	...
	// It deletes the `key` if `duration` < 0 or given `value` is nil, but it does nothing
	// if `value` is a function and the function result is nil.
	GetOrSetFunc(ctx context.Context, key interface{}, f Func, duration time.Duration) (result *jvar.Var, err error)
	...
	// writing mutex lock for concurrent safety purpose.
	GetOrSetFuncLock(ctx context.Context, key interface{}, f Func, duration time.Duration) (result *jvar.Var, err error)
	...
	Update(ctx context.Context, key interface{}, value interface{}) (oldValue *jvar.Var, exist bool, err error)
	...
	Remove(ctx context.Context, keys ...interface{}) (lastValue *jvar.Var, err error)
