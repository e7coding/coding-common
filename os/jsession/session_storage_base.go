...
func (s *StorageBase) GetSession(ctx context.Context, sessionId string, ttl time.Duration) (*jmap.StrAnyMap, error) {
	return nil, ErrorDisabled
}
...
func (s *StorageBase) SetSession(ctx context.Context, sessionId string, sessionData *jmap.StrAnyMap, ttl time.Duration) error {
	return ErrorDisabled
}
