...
type HashReader interface {
	HGet(ctx context.Context, key, field string) (*dvar.Var, error)
	HMGet(ctx context.Context, key string, fields ...string) (dvar.Vars, error)
	HGetAll(ctx context.Context, key string) (*dvar.Var, error)
	HKeys(ctx context.Context, key string) ([]string, error)
	HVals(ctx context.Context, key string) (dvar.Vars, error)
