...
type StrWriter interface {
	Set(ctx context.Context, key string, value interface{}, option ...SetOption) (*dvar.Var, error)
	...
	GetSet(ctx context.Context, key string, value interface{}) (*dvar.Var, error)
...
type StrReader interface {
	Get(ctx context.Context, key string) (*dvar.Var, error)
	GetDel(ctx context.Context, key string) (*dvar.Var, error)
	GetEX(ctx context.Context, key string, option ...GetEXOption) (*dvar.Var, error)
	StrLen(ctx context.Context, key string) (int64, error)
	GetRange(ctx context.Context, key string, start, end int64) (string, error)
	MGet(ctx context.Context, keys ...string) (map[string]*dvar.Var, error)
}
