...
func New(config ...*Config) (*Redis, error) {
	...
	if usedConfig == nil {
		return nil, werr.WithMsgF("未找到用于创建 Redis 客户端的配置")
	}
	if usedAdapter == nil {
		return nil, werr.WithMsgF(errorNilAdapter)
	}
	redis := &Redis{
		config:       usedConfig,
...
func NewWithAdapter(adapter Adapter) (*Redis, error) {
	if adapter == nil {
		return nil, werr.WithMsgF("adapter 不能为空")
	}
...
func (r *Redis) SetAdapter(adapter Adapter) {
	if r == nil {
		panic(werr.WithMsg(errorNilRedis))
	}
...
func (r *Redis) Conn() (Conn, error) {
	if r == nil {
		return nil, werr.WithMsg(errorNilRedis)
	}
	if r.localAdapter == nil {
		return nil, werr.WithMsg(errorNilAdapter)
	}
...
func (r *Redis) Do(command string, args ...interface{}) (*dvar.Var, error) {
	if r == nil {
		return nil, werr.WithMsg(errorNilRedis)
	}
	if r.localAdapter == nil {
