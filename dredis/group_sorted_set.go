...
type SortedSetWriter interface {
	ZAdd(ctx context.Context, key string, option *ZAddOption, member ZAddMember, members ...ZAddMember) (*dvar.Var, error)
...
type SortedSetReader interface {
	...
	ZRange(ctx context.Context, key string, start, stop int64, option ...ZRangeOption) (dvar.Vars, error)
	ZRevRange(ctx context.Context, key string, start, stop int64, option ...ZRevRangeOption) (*dvar.Var, error)
