...
// Var 以 *dvar.Var 形式返回 Json 值。
func (j *Json) Var() *dvar.Var {
	return dvar.New(j.Interface())
}
...
func (j *Json) Get(pattern string, def ...interface{}) *dvar.Var {
	if j == nil {
		return nil
	}
	j.mu.RLock()
...
func (j *Json) Append(pattern string, value interface{}) error {
	...
	return werr.WithMsgF("无效的变量类型 %s", pattern)
}
