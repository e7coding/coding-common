...
func Marshal(v interface{}) (marshaledBytes []byte, err error) {
	...
	if err != nil {
		err = werr.WithMsgErr(err, `json.Marshal failed`)
	}
	return
}
...
func MarshalIndent(v interface{}, prefix, indent string) (marshaledBytes []byte, err error) {
	...
	if err != nil {
		err = werr.WithMsgErr(err, `json.MarshalIndent failed`)
	}
	return
}
...
func Unmarshal(data []byte, v interface{}) (err error) {
	...
	if err != nil {
		err = werr.WithMsgErr(err, `json.Unmarshal failed`)
	}
	return
}
...
func UnmarshalUseNumber(data []byte, v interface{}) (err error) {
	...
	if err != nil {
		err = werr.WithMsgErr(err, `json.UnmarshalUseNumber failed`)
	}
	return
}
