...
func (t *AVLTree) UnmarshalJSON(b []byte) error {
	if t.comparator == nil {
		t.comparator = dutil.ComparatorString
...
// GetVarOrSet 和 GetVarOrSetFunc 返回 dvar.Var。
func (t *AVLTree) GetVar(key any) *dvar.Var         { return dvar.New(t.Get(key)) }
func (t *AVLTree) GetVarOrSet(key, v any) *dvar.Var { return dvar.New(t.GetOrSet(key, v)) }
func (t *AVLTree) GetVarFunc(key any, f func() any) *dvar.Var {
	return dvar.New(t.GetOrSetFunc(key, f))
}
